            ...
            <div class="container">
                ...
                <table border="1">
                    ...
                    <tr>
                        ...
                        <button type="submit" name="cancel" value="<?= $req['req_id']; ?>">Delete</button>
                            <?php
                            // Check the status before displaying the buttons
                            
                            if ($req['req_status'] !== 'DONE' && $req['req_status'] !== 'PENDING') {
                                ?>
                                <!-- Display the buttons for Approve, Cancel, and Received -->
                                
                                
                                <button type="submit" name="received" value="<?= $req['req_id']; ?>">Received</button>
                            <?php } ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
